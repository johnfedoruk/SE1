...
public class EditBirdTest extends ActivityInstrumentationTestCase2<SplashScreen> {
  	private Solo solo;
	...
	public void testRun() {
		...
		solo.enterText((android.widget.EditText) solo.getView(net.javacrypt.se1.R.id.txtBirdName, 1), "Edited Name");
        //Click on Add Bird
